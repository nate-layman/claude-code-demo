...
1. **Define the end state** - Specify what success looks like
2. <span style="background-color: #ffffcc; padding: 4px 8px; display: inline-block; width: 100%;">**Create verification** - Design tests that prove success</span>
3. <span style="background-color: #ffffcc; padding: 4px 8px; display: inline-block; width: 100%;">**Find the path** - Iteratively code until tests pass</span>
